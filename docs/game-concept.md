...
- No binary release is ever published. Whoever wants to run it compiles, configures, sets up and administers it themselves (D-065). The repository is source available, not open source (D-066).
