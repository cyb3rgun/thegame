...
All texture sets come from Poly Haven under CC0 1.0 Universal (https://polyhaven.com/license). CC0 asks for no attribution; the authors are named here because the project wants to credit them. The sets stay CC0 inside the project: the project licences do not add conditions to them.
